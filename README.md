...
Disconnected fork of original at: https://github.com/eslint-types/eslint-define-config
changes: 
- reexport rules for the plugins
- allows overrides of rules
- supprots renaming rules
